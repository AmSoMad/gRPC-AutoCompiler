...
class InspectRequest extends $pb.GeneratedMessage {
  factory InspectRequest({
    $core.String? barCode,
    $1.Timestamp? workDate,
    $1.Timestamp? scanTime,
  }) {
    final $result = create();
    if (barCode != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InspectRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'inspect'), createEmptyInstance: create)
    ...
    ..aOM<$1.Timestamp>(2, _omitFieldNames ? '' : 'workDate', protoName: 'workDate', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(3, _omitFieldNames ? '' : 'scanTime', protoName: 'scanTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1.Timestamp get workDate => $_getN(1);
  @$pb.TagNumber(2)
  set workDate($1.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasWorkDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearWorkDate() => clearField(2);
  @$pb.TagNumber(2)
  $1.Timestamp ensureWorkDate() => $_ensure(1);

  @$pb.TagNumber(3)
  $1.Timestamp get scanTime => $_getN(2);
  @$pb.TagNumber(3)
  set scanTime($1.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasScanTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearScanTime() => clearField(3);
  @$pb.TagNumber(3)
  $1.Timestamp ensureScanTime() => $_ensure(2);
}

class InspectReply extends $pb.GeneratedMessage {
  factory InspectReply({
    $core.String? message,
  }) {
    final $result = create();
    if (message != null) {
...
class InspectListRequest extends $pb.GeneratedMessage {
  factory InspectListRequest({
    $1.Timestamp? inspectDate,
  }) {
    final $result = create();
    if (inspectDate != null) {
      $result.inspectDate = inspectDate;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InspectListRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'inspect'), createEmptyInstance: create)
    ..aOM<$1.Timestamp>(1, _omitFieldNames ? '' : 'inspectDate', protoName: 'inspectDate', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1.Timestamp get inspectDate => $_getN(0);
  @$pb.TagNumber(1)
  set inspectDate($1.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInspectDate() => $_has(0);
  @$pb.TagNumber(1)
  void clearInspectDate() => clearField(1);
  @$pb.TagNumber(1)
  $1.Timestamp ensureInspectDate() => $_ensure(0);
}

class InspectListReply extends $pb.GeneratedMessage {
  factory InspectListReply({
    $core.String? inspectJson,
  }) {
    final $result = create();
    if (inspectJson != null) {
      $result.inspectJson = inspectJson;
    }
    return $result;
  }
