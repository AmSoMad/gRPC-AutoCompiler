...
class DeptResponse extends $pb.GeneratedMessage {
  factory DeptResponse({
    $core.List<$core.int>? dept,
...
class DeptSetResponse extends $pb.GeneratedMessage {
  factory DeptSetResponse({
    $core.List<$core.int>? deptSet,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (deptSet != null) {
      $result.deptSet = deptSet;
    }
    if (jsonString != null) {
      $result.jsonString = jsonString;
    }
...
class GetForExpenseAccountRequest extends $pb.GeneratedMessage {
  factory GetForExpenseAccountRequest({
    $core.int? expenseCode,
  }) {
    final $result = create();
    if (expenseCode != null) {
      $result.expenseCode = expenseCode;
    }
    return $result;
  }
...
class GetForBusinessClassRequest extends $pb.GeneratedMessage {
  factory GetForBusinessClassRequest({
...
class InsertRequest extends $pb.GeneratedMessage {
  factory InsertRequest({
    ...
    $core.int? useFlag,
    $core.int? items,
    $core.int? companyCode,
    $core.int? budgetFlag,
    $2.StringValue? linkCode,
    $core.int? taxFlag,
  }) {
    final $result = create();
    if (deptCode != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'DeptSvc'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'deptCode', $pb.PbFieldType.OS3, protoName: 'deptCode')
    ..aOM<$2.Int32Value>(2, _omitFieldNames ? '' : 'expenseCode', protoName: 'expenseCode', subBuilder: $2.Int32Value.create)
    ...
    ..aOM<$2.Int32Value>(7, _omitFieldNames ? '' : 'businessClassCode', protoName: 'businessClassCode', subBuilder: $2.Int32Value.create)
    ...
    ..aOM<$2.StringValue>(13, _omitFieldNames ? '' : 'linkCode', protoName: 'linkCode', subBuilder: $2.StringValue.create)
  ...
  @$pb.TagNumber(2)
  $2.Int32Value get expenseCode => $_getN(1);
  @$pb.TagNumber(2)
  set expenseCode($2.Int32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExpenseCode() => $_has(1);
  @$pb.TagNumber(2)
  void clearExpenseCode() => clearField(2);
  @$pb.TagNumber(2)
  $2.Int32Value ensureExpenseCode() => $_ensure(1);
  ...
  @$pb.TagNumber(7)
  $2.Int32Value get businessClassCode => $_getN(6);
  @$pb.TagNumber(7)
  set businessClassCode($2.Int32Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasBusinessClassCode() => $_has(6);
  @$pb.TagNumber(7)
  void clearBusinessClassCode() => clearField(7);
  @$pb.TagNumber(7)
  $2.Int32Value ensureBusinessClassCode() => $_ensure(6);
  ...
  @$pb.TagNumber(13)
  $2.StringValue get linkCode => $_getN(12);
  @$pb.TagNumber(13)
  set linkCode($2.StringValue v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasLinkCode() => $_has(12);
  @$pb.TagNumber(13)
  void clearLinkCode() => clearField(13);
  @$pb.TagNumber(13)
  $2.StringValue ensureLinkCode() => $_ensure(12);
