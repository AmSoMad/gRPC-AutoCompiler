...
class CalendarsResponse extends $pb.GeneratedMessage {
  factory CalendarsResponse({
    $core.List<$core.int>? calendars,
...
class CalendarsSetResponse extends $pb.GeneratedMessage {
  factory CalendarsSetResponse({
    $core.List<$core.int>? calendarsSet,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (calendarsSet != null) {
      $result.calendarsSet = calendarsSet;
    }
    if (jsonString != null) {
      $result.jsonString = jsonString;
    }
...
class GetByKeyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetByKeyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'CalendarsSvc'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'calendarType', $pb.PbFieldType.OS3, protoName: 'calendarType')
    ..aOM<$2.Timestamp>(2, _omitFieldNames ? '' : 'calendarDate', protoName: 'calendarDate', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2.Timestamp get calendarDate => $_getN(1);
  @$pb.TagNumber(2)
  set calendarDate($2.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCalendarDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearCalendarDate() => clearField(2);
  @$pb.TagNumber(2)
  $2.Timestamp ensureCalendarDate() => $_ensure(1);
}
...
class InsertRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'CalendarsSvc'), createEmptyInstance: create)
    ...
    ..aOM<$3.StringValue>(5, _omitFieldNames ? '' : 'remarks', subBuilder: $3.StringValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $3.StringValue get remarks => $_getN(4);
  @$pb.TagNumber(5)
  set remarks($3.StringValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRemarks() => $_has(4);
  @$pb.TagNumber(5)
  void clearRemarks() => clearField(5);
  @$pb.TagNumber(5)
  $3.StringValue ensureRemarks() => $_ensure(4);
}
