...
class PartSpecsResponse extends $pb.GeneratedMessage {
  factory PartSpecsResponse({
    $core.List<$core.int>? partSpecs,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (partSpecs != null) {
      $result.partSpecs = partSpecs;
    }
    if (jsonString != null) {
...
class PartSpecsSetResponse extends $pb.GeneratedMessage {
  factory PartSpecsSetResponse({
    $core.List<$core.int>? partSpecsSet,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (partSpecsSet != null) {
      $result.partSpecsSet = partSpecsSet;
    }
    if (jsonString != null) {
      $result.jsonString = jsonString;
    }
...
class GetForPartGroupRequest extends $pb.GeneratedMessage {
  factory GetForPartGroupRequest({
    $core.String? partGroupCode,
  }) {
    final $result = create();
    if (partGroupCode != null) {
      $result.partGroupCode = partGroupCode;
    }
    return $result;
  }
...
class InsertRequest extends $pb.GeneratedMessage {
  factory InsertRequest({
    $core.String? partCode,
    $core.String? partSpec,
    GrpcDecimal? logicalWeight,
    GrpcDecimal? scrapPercent,
    $core.String? bin,
    $2.Timestamp? nextCycleCount,
    $core.int? unUseFlag,
    GrpcDecimal? standardCost,
    GrpcDecimal? currentCost,
    $core.String? partType,
    GrpcDecimal? safetyQty2,
    GrpcDecimal? reOrderLevel2,
    $core.String? partName2,
    $3.Int32Value? stockTypeFlag,
    GrpcDecimal? packingUnitQuantity,
    $core.int? lOTQty,
    $core.int? roundingFlag,
    $core.String? partCodeX,
    $core.String? partSpecX,
    $3.StringValue? measureUnit,
    $3.StringValue? route,
    $3.Int32Value? commodityCode,
    $3.StringValue? remarks,
    $core.int? orderLeadTime,
    $core.int? orderCoverPeriod,
    $core.int? orderIncrement,
    $3.StringValue? model,
    $3.Int32Value? moldedPlateNumber,
    $3.StringValue? partGroupCode,
    $3.Int32Value? seqNo,
    $3.StringValue? partShortName,
    $3.StringValue? partClass,
    $3.StringValue? foodDrugAdministrationItemCode,
    GrpcDecimal? yield,
    $3.Int32Value? partType2,
    $3.StringValue? barCode,
  }) {
    final $result = create();
    if (partCode != null) {
      $result.partCode = partCode;
    ...
    if (logicalWeight != null) {
      $result.logicalWeight = logicalWeight;
    }
    if (scrapPercent != null) {
      $result.scrapPercent = scrapPercent;
    }
    if (bin != null) {
      $result.bin = bin;
    }
    if (nextCycleCount != null) {
      $result.nextCycleCount = nextCycleCount;
    }
    if (unUseFlag != null) {
      $result.unUseFlag = unUseFlag;
    }
    if (standardCost != null) {
      $result.standardCost = standardCost;
    }
    if (currentCost != null) {
    ...
    if (safetyQty2 != null) {
      $result.safetyQty2 = safetyQty2;
    }
    if (reOrderLevel2 != null) {
      $result.reOrderLevel2 = reOrderLevel2;
    }
    if (partName2 != null) {
      $result.partName2 = partName2;
    }
    if (stockTypeFlag != null) {
      $result.stockTypeFlag = stockTypeFlag;
    }
    if (packingUnitQuantity != null) {
      $result.packingUnitQuantity = packingUnitQuantity;
    }
    if (lOTQty != null) {
      $result.lOTQty = lOTQty;
    }
    if (roundingFlag != null) {
      $result.roundingFlag = roundingFlag;
    }
    if (partCodeX != null) {
      $result.partCodeX = partCodeX;
    }
    if (partSpecX != null) {
      $result.partSpecX = partSpecX;
    }
    if (measureUnit != null) {
    ...
    if (orderLeadTime != null) {
      $result.orderLeadTime = orderLeadTime;
    }
    if (orderCoverPeriod != null) {
      $result.orderCoverPeriod = orderCoverPeriod;
    }
    if (orderIncrement != null) {
      $result.orderIncrement = orderIncrement;
    }
    if (model != null) {
      $result.model = model;
    }
    if (moldedPlateNumber != null) {
      $result.moldedPlateNumber = moldedPlateNumber;
    }
    if (partGroupCode != null) {
      $result.partGroupCode = partGroupCode;
    }
    ...
    if (partShortName != null) {
      $result.partShortName = partShortName;
    }
    if (partClass != null) {
      $result.partClass = partClass;
    }
    if (foodDrugAdministrationItemCode != null) {
      $result.foodDrugAdministrationItemCode = foodDrugAdministrationItemCode;
    }
    if (yield != null) {
      $result.yield = yield;
    }
    if (partType2 != null) {
      $result.partType2 = partType2;
    }
    if (barCode != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'PartSpecsSvc'), createEmptyInstance: create)
    ...
    ..aOM<$2.Timestamp>(6, _omitFieldNames ? '' : 'nextCycleCount', protoName: 'nextCycleCount', subBuilder: $2.Timestamp.create)
    ...
    ..aOM<$3.Int32Value>(14, _omitFieldNames ? '' : 'stockTypeFlag', protoName: 'stockTypeFlag', subBuilder: $3.Int32Value.create)
    ...
    ..aOM<$3.StringValue>(20, _omitFieldNames ? '' : 'measureUnit', protoName: 'measureUnit', subBuilder: $3.StringValue.create)
    ..aOM<$3.StringValue>(21, _omitFieldNames ? '' : 'route', subBuilder: $3.StringValue.create)
    ..aOM<$3.Int32Value>(22, _omitFieldNames ? '' : 'commodityCode', protoName: 'commodityCode', subBuilder: $3.Int32Value.create)
    ..aOM<$3.StringValue>(23, _omitFieldNames ? '' : 'remarks', subBuilder: $3.StringValue.create)
    ...
    ..aOM<$3.StringValue>(27, _omitFieldNames ? '' : 'model', subBuilder: $3.StringValue.create)
    ..aOM<$3.Int32Value>(28, _omitFieldNames ? '' : 'moldedPlateNumber', protoName: 'moldedPlateNumber', subBuilder: $3.Int32Value.create)
    ..aOM<$3.StringValue>(29, _omitFieldNames ? '' : 'partGroupCode', protoName: 'partGroupCode', subBuilder: $3.StringValue.create)
    ..aOM<$3.Int32Value>(30, _omitFieldNames ? '' : 'seqNo', protoName: 'seqNo', subBuilder: $3.Int32Value.create)
    ..aOM<$3.StringValue>(31, _omitFieldNames ? '' : 'partShortName', protoName: 'partShortName', subBuilder: $3.StringValue.create)
    ..aOM<$3.StringValue>(32, _omitFieldNames ? '' : 'partClass', protoName: 'partClass', subBuilder: $3.StringValue.create)
    ..aOM<$3.StringValue>(33, _omitFieldNames ? '' : 'foodDrugAdministrationItemCode', protoName: 'foodDrugAdministrationItemCode', subBuilder: $3.StringValue.create)
    ..aOM<GrpcDecimal>(34, _omitFieldNames ? '' : 'Yield', protoName: 'Yield', subBuilder: GrpcDecimal.create)
    ..aOM<$3.Int32Value>(35, _omitFieldNames ? '' : 'partType2', protoName: 'partType2', subBuilder: $3.Int32Value.create)
    ..aOM<$3.StringValue>(36, _omitFieldNames ? '' : 'barCode', protoName: 'barCode', subBuilder: $3.StringValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $2.Timestamp get nextCycleCount => $_getN(5);
  @$pb.TagNumber(6)
  set nextCycleCount($2.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNextCycleCount() => $_has(5);
  @$pb.TagNumber(6)
  void clearNextCycleCount() => clearField(6);
  @$pb.TagNumber(6)
  $2.Timestamp ensureNextCycleCount() => $_ensure(5);
  ...
  @$pb.TagNumber(14)
  $3.Int32Value get stockTypeFlag => $_getN(13);
  @$pb.TagNumber(14)
  set stockTypeFlag($3.Int32Value v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasStockTypeFlag() => $_has(13);
  @$pb.TagNumber(14)
  void clearStockTypeFlag() => clearField(14);
  @$pb.TagNumber(14)
  $3.Int32Value ensureStockTypeFlag() => $_ensure(13);
  ...
  @$pb.TagNumber(20)
  $3.StringValue get measureUnit => $_getN(19);
  @$pb.TagNumber(20)
  set measureUnit($3.StringValue v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasMeasureUnit() => $_has(19);
  @$pb.TagNumber(20)
  void clearMeasureUnit() => clearField(20);
  @$pb.TagNumber(20)
  $3.StringValue ensureMeasureUnit() => $_ensure(19);

  @$pb.TagNumber(21)
  $3.StringValue get route => $_getN(20);
  @$pb.TagNumber(21)
  set route($3.StringValue v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasRoute() => $_has(20);
  @$pb.TagNumber(21)
  void clearRoute() => clearField(21);
  @$pb.TagNumber(21)
  $3.StringValue ensureRoute() => $_ensure(20);

  @$pb.TagNumber(22)
  $3.Int32Value get commodityCode => $_getN(21);
  @$pb.TagNumber(22)
  set commodityCode($3.Int32Value v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasCommodityCode() => $_has(21);
  @$pb.TagNumber(22)
  void clearCommodityCode() => clearField(22);
  @$pb.TagNumber(22)
  $3.Int32Value ensureCommodityCode() => $_ensure(21);

  @$pb.TagNumber(23)
  $3.StringValue get remarks => $_getN(22);
  @$pb.TagNumber(23)
  set remarks($3.StringValue v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasRemarks() => $_has(22);
  @$pb.TagNumber(23)
  void clearRemarks() => clearField(23);
  @$pb.TagNumber(23)
  $3.StringValue ensureRemarks() => $_ensure(22);
  ...
  @$pb.TagNumber(27)
  $3.StringValue get model => $_getN(26);
  @$pb.TagNumber(27)
  set model($3.StringValue v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasModel() => $_has(26);
  @$pb.TagNumber(27)
  void clearModel() => clearField(27);
  @$pb.TagNumber(27)
  $3.StringValue ensureModel() => $_ensure(26);

  @$pb.TagNumber(28)
  $3.Int32Value get moldedPlateNumber => $_getN(27);
  @$pb.TagNumber(28)
  set moldedPlateNumber($3.Int32Value v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasMoldedPlateNumber() => $_has(27);
  @$pb.TagNumber(28)
  void clearMoldedPlateNumber() => clearField(28);
  @$pb.TagNumber(28)
  $3.Int32Value ensureMoldedPlateNumber() => $_ensure(27);

  @$pb.TagNumber(29)
  $3.StringValue get partGroupCode => $_getN(28);
  @$pb.TagNumber(29)
  set partGroupCode($3.StringValue v) { setField(29, v); }
  @$pb.TagNumber(29)
  $core.bool hasPartGroupCode() => $_has(28);
  @$pb.TagNumber(29)
  void clearPartGroupCode() => clearField(29);
  @$pb.TagNumber(29)
  $3.StringValue ensurePartGroupCode() => $_ensure(28);

  @$pb.TagNumber(30)
  $3.Int32Value get seqNo => $_getN(29);
  @$pb.TagNumber(30)
  set seqNo($3.Int32Value v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasSeqNo() => $_has(29);
  @$pb.TagNumber(30)
  void clearSeqNo() => clearField(30);
  @$pb.TagNumber(30)
  $3.Int32Value ensureSeqNo() => $_ensure(29);

  @$pb.TagNumber(31)
  $3.StringValue get partShortName => $_getN(30);
  @$pb.TagNumber(31)
  set partShortName($3.StringValue v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasPartShortName() => $_has(30);
  @$pb.TagNumber(31)
  void clearPartShortName() => clearField(31);
  @$pb.TagNumber(31)
  $3.StringValue ensurePartShortName() => $_ensure(30);

  @$pb.TagNumber(32)
  $3.StringValue get partClass => $_getN(31);
  @$pb.TagNumber(32)
  set partClass($3.StringValue v) { setField(32, v); }
  @$pb.TagNumber(32)
  $core.bool hasPartClass() => $_has(31);
  @$pb.TagNumber(32)
  void clearPartClass() => clearField(32);
  @$pb.TagNumber(32)
  $3.StringValue ensurePartClass() => $_ensure(31);

  @$pb.TagNumber(33)
  $3.StringValue get foodDrugAdministrationItemCode => $_getN(32);
  @$pb.TagNumber(33)
  set foodDrugAdministrationItemCode($3.StringValue v) { setField(33, v); }
  @$pb.TagNumber(33)
  $core.bool hasFoodDrugAdministrationItemCode() => $_has(32);
  @$pb.TagNumber(33)
  void clearFoodDrugAdministrationItemCode() => clearField(33);
  @$pb.TagNumber(33)
  $3.StringValue ensureFoodDrugAdministrationItemCode() => $_ensure(32);
  ...
  @$pb.TagNumber(35)
  $3.Int32Value get partType2 => $_getN(34);
  @$pb.TagNumber(35)
  set partType2($3.Int32Value v) { setField(35, v); }
  @$pb.TagNumber(35)
  $core.bool hasPartType2() => $_has(34);
  @$pb.TagNumber(35)
  void clearPartType2() => clearField(35);
  @$pb.TagNumber(35)
  $3.Int32Value ensurePartType2() => $_ensure(34);

  @$pb.TagNumber(36)
  $3.StringValue get barCode => $_getN(35);
  @$pb.TagNumber(36)
  set barCode($3.StringValue v) { setField(36, v); }
  @$pb.TagNumber(36)
  $core.bool hasBarCode() => $_has(35);
  @$pb.TagNumber(36)
  void clearBarCode() => clearField(36);
  @$pb.TagNumber(36)
  $3.StringValue ensureBarCode() => $_ensure(35);
}
