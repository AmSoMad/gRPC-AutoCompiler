...
class BusinessClass_SaleResponse extends $pb.GeneratedMessage {
  factory BusinessClass_SaleResponse({
    $core.List<$core.int>? businessClassSale,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (businessClassSale != null) {
      $result.businessClassSale = businessClassSale;
    }
    if (jsonString != null) {
...
class BusinessClass_SaleSetResponse extends $pb.GeneratedMessage {
  factory BusinessClass_SaleSetResponse({
    $core.List<$core.int>? businessClassSaleSet,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (businessClassSaleSet != null) {
      $result.businessClassSaleSet = businessClassSaleSet;
    }
    if (jsonString != null) {
      $result.jsonString = jsonString;
    }
...
class InsertRequest extends $pb.GeneratedMessage {
  factory InsertRequest({
    ...
    $2.Int32Value? productLocationNo,
  }) {
    final $result = create();
    if (businessClassCode != null) {
      $result.businessClassCode = businessClassCode;
    ...
    if (productLocationNo != null) {
      $result.productLocationNo = productLocationNo;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'BusinessClass_SaleSvc'), createEmptyInstance: create)
    ...
    ..aOM<$2.StringValue>(8, _omitFieldNames ? '' : 'customerCode', protoName: 'customerCode', subBuilder: $2.StringValue.create)
    ..aOM<$2.Int32Value>(9, _omitFieldNames ? '' : 'locationNo', protoName: 'locationNo', subBuilder: $2.Int32Value.create)
    ..aOM<$2.Int32Value>(10, _omitFieldNames ? '' : 'productLocationNo', protoName: 'productLocationNo', subBuilder: $2.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $2.StringValue get customerCode => $_getN(7);
  @$pb.TagNumber(8)
  set customerCode($2.StringValue v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCustomerCode() => $_has(7);
  @$pb.TagNumber(8)
  void clearCustomerCode() => clearField(8);
  @$pb.TagNumber(8)
  $2.StringValue ensureCustomerCode() => $_ensure(7);

  @$pb.TagNumber(9)
  $2.Int32Value get locationNo => $_getN(8);
  @$pb.TagNumber(9)
  set locationNo($2.Int32Value v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasLocationNo() => $_has(8);
  @$pb.TagNumber(9)
  void clearLocationNo() => clearField(9);
  @$pb.TagNumber(9)
  $2.Int32Value ensureLocationNo() => $_ensure(8);

  @$pb.TagNumber(10)
  $2.Int32Value get productLocationNo => $_getN(9);
  @$pb.TagNumber(10)
  set productLocationNo($2.Int32Value v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasProductLocationNo() => $_has(9);
  @$pb.TagNumber(10)
  void clearProductLocationNo() => clearField(10);
  @$pb.TagNumber(10)
  $2.Int32Value ensureProductLocationNo() => $_ensure(9);
}
