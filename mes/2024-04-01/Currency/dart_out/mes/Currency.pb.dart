...
class CurrencySetResponse extends $pb.GeneratedMessage {
  factory CurrencySetResponse({
    $core.List<$core.int>? currencySet,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (currencySet != null) {
      $result.currencySet = currencySet;
    }
    if (jsonString != null) {
      $result.jsonString = jsonString;
    }
...
class InsertRequest extends $pb.GeneratedMessage {
  factory InsertRequest({
    ...
    $2.StringValue? countryCode,
    $2.StringValue? currencyName,
  }) {
    final $result = create();
    if (currency != null) {
      $result.currency = currency;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'CurrencySvc'), createEmptyInstance: create)
    ...
    ..aOM<$2.StringValue>(3, _omitFieldNames ? '' : 'countryCode', protoName: 'countryCode', subBuilder: $2.StringValue.create)
    ..aOM<$2.StringValue>(4, _omitFieldNames ? '' : 'currencyName', protoName: 'currencyName', subBuilder: $2.StringValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $2.StringValue get countryCode => $_getN(2);
  @$pb.TagNumber(3)
  set countryCode($2.StringValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCountryCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearCountryCode() => clearField(3);
  @$pb.TagNumber(3)
  $2.StringValue ensureCountryCode() => $_ensure(2);

  @$pb.TagNumber(4)
  $2.StringValue get currencyName => $_getN(3);
  @$pb.TagNumber(4)
  set currencyName($2.StringValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCurrencyName() => $_has(3);
  @$pb.TagNumber(4)
  void clearCurrencyName() => clearField(4);
  @$pb.TagNumber(4)
  $2.StringValue ensureCurrencyName() => $_ensure(3);
}
