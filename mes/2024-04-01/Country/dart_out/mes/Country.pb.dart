...
class CountrySetResponse extends $pb.GeneratedMessage {
  factory CountrySetResponse({
    $core.List<$core.int>? countrySet,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (countrySet != null) {
      $result.countrySet = countrySet;
    }
    if (jsonString != null) {
      $result.jsonString = jsonString;
    }
...
class InsertRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'CountrySvc'), createEmptyInstance: create)
    ...
    ..aOM<$2.StringValue>(3, _omitFieldNames ? '' : 'areaCode', protoName: 'areaCode', subBuilder: $2.StringValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $2.StringValue get areaCode => $_getN(2);
  @$pb.TagNumber(3)
  set areaCode($2.StringValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAreaCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearAreaCode() => clearField(3);
  @$pb.TagNumber(3)
  $2.StringValue ensureAreaCode() => $_ensure(2);
}
