...
class CostCentersResponse extends $pb.GeneratedMessage {
  factory CostCentersResponse({
    $core.List<$core.int>? costCenters,
...
class CostCentersSetResponse extends $pb.GeneratedMessage {
  factory CostCentersSetResponse({
    $core.List<$core.int>? costCentersSet,
    $core.String? jsonString,
  }) {
    final $result = create();
    if (costCentersSet != null) {
      $result.costCentersSet = costCentersSet;
    }
    if (jsonString != null) {
      $result.jsonString = jsonString;
    }
...
class GetForCalendarTypeRequest extends $pb.GeneratedMessage {
  factory GetForCalendarTypeRequest({
...
class GetForCostCenterTypesRequest extends $pb.GeneratedMessage {
  factory GetForCostCenterTypesRequest({
...
class GetForInspectionSystemsRequest extends $pb.GeneratedMessage {
  factory GetForInspectionSystemsRequest({
    $core.int? systemID,
  }) {
    final $result = create();
    if (systemID != null) {
...
class GetForMeasureUnitRequest extends $pb.GeneratedMessage {
  factory GetForMeasureUnitRequest({
    $core.String? measureUnit,
  }) {
    final $result = create();
    if (measureUnit != null) {
...
class InsertRequest extends $pb.GeneratedMessage {
  factory InsertRequest({
    $core.String? costCenter,
    $core.int? calendarType,
    $core.String? costCenterName,
    $core.int? machines,
    GrpcDecimal? effectivePercent,
    GrpcDecimal? stdLaborRate,
    GrpcDecimal? curLaborRate,
    GrpcDecimal? stdSetupRate,
    GrpcDecimal? curSetupRate,
    GrpcDecimal? stdLaborOverhead,
    GrpcDecimal? curLaborOverhead,
    GrpcDecimal? stdSetupOverhead,
    GrpcDecimal? curSetupOverhead,
    GrpcDecimal? trialLaborRate,
    GrpcDecimal? trialSetupRate,
    GrpcDecimal? trialLaborOverhead,
    GrpcDecimal? trialSetupOverhead,
    $2.StringValue? customerCode,
    $2.Int32Value? opTimeCalculationMethod,
    $2.Int32Value? locationNo,
    $core.int? workLevel,
    $2.StringValue? costCenterType,
    $core.int? workType,
    GrpcDecimal? addedValue,
    $core.int? centerType,
    $2.StringValue? machineCostCenter,
    $2.Int32Value? businessClassCode,
    $core.int? capaFlag,
    $core.String? centerLotChar,
    $core.int? centerNumber,
    $core.String? workMSpec,
    $core.int? seqNo,
    $2.Int32Value? systemID,
    $core.int? useFlag,
    $2.StringValue? mACAddress,
    $2.Int32Value? outSourcingType,
    $core.String? measureUnit,
  }) {
    final $result = create();
    if (costCenter != null) {
    ...
    if (costCenterName != null) {
      $result.costCenterName = costCenterName;
    }
    if (machines != null) {
      $result.machines = machines;
    }
    if (effectivePercent != null) {
      $result.effectivePercent = effectivePercent;
    }
    if (stdLaborRate != null) {
      $result.stdLaborRate = stdLaborRate;
    }
    if (curLaborRate != null) {
      $result.curLaborRate = curLaborRate;
    }
    if (stdSetupRate != null) {
      $result.stdSetupRate = stdSetupRate;
    }
    if (curSetupRate != null) {
      $result.curSetupRate = curSetupRate;
    }
    if (stdLaborOverhead != null) {
      $result.stdLaborOverhead = stdLaborOverhead;
    }
    if (curLaborOverhead != null) {
      $result.curLaborOverhead = curLaborOverhead;
    }
    if (stdSetupOverhead != null) {
      $result.stdSetupOverhead = stdSetupOverhead;
    }
    if (curSetupOverhead != null) {
      $result.curSetupOverhead = curSetupOverhead;
    }
    if (trialLaborRate != null) {
      $result.trialLaborRate = trialLaborRate;
    }
    if (trialSetupRate != null) {
      $result.trialSetupRate = trialSetupRate;
    }
    if (trialLaborOverhead != null) {
      $result.trialLaborOverhead = trialLaborOverhead;
    }
    if (trialSetupOverhead != null) {
      $result.trialSetupOverhead = trialSetupOverhead;
    }
    if (customerCode != null) {
      $result.customerCode = customerCode;
    }
    if (opTimeCalculationMethod != null) {
      $result.opTimeCalculationMethod = opTimeCalculationMethod;
    }
    if (locationNo != null) {
      $result.locationNo = locationNo;
    }
    if (workLevel != null) {
      $result.workLevel = workLevel;
    }
    if (costCenterType != null) {
      $result.costCenterType = costCenterType;
    }
    ...
    if (addedValue != null) {
      $result.addedValue = addedValue;
    }
    if (centerType != null) {
      $result.centerType = centerType;
    }
    if (machineCostCenter != null) {
      $result.machineCostCenter = machineCostCenter;
    }
    if (businessClassCode != null) {
      $result.businessClassCode = businessClassCode;
    }
    if (capaFlag != null) {
      $result.capaFlag = capaFlag;
    }
    if (centerLotChar != null) {
      $result.centerLotChar = centerLotChar;
    }
    if (centerNumber != null) {
      $result.centerNumber = centerNumber;
    }
    if (workMSpec != null) {
      $result.workMSpec = workMSpec;
    }
    if (seqNo != null) {
      $result.seqNo = seqNo;
    }
    ...
    if (outSourcingType != null) {
      $result.outSourcingType = outSourcingType;
    }
    if (measureUnit != null) {
      $result.measureUnit = measureUnit;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'CostCentersSvc'), createEmptyInstance: create)
    ...
    ..aOM<$2.StringValue>(18, _omitFieldNames ? '' : 'customerCode', protoName: 'customerCode', subBuilder: $2.StringValue.create)
    ..aOM<$2.Int32Value>(19, _omitFieldNames ? '' : 'opTimeCalculationMethod', protoName: 'opTimeCalculationMethod', subBuilder: $2.Int32Value.create)
    ..aOM<$2.Int32Value>(20, _omitFieldNames ? '' : 'locationNo', protoName: 'locationNo', subBuilder: $2.Int32Value.create)
    ..a<$core.int>(21, _omitFieldNames ? '' : 'workLevel', $pb.PbFieldType.OS3, protoName: 'workLevel')
    ..aOM<$2.StringValue>(22, _omitFieldNames ? '' : 'costCenterType', protoName: 'costCenterType', subBuilder: $2.StringValue.create)
    ...
    ..aOM<$2.StringValue>(26, _omitFieldNames ? '' : 'machineCostCenter', protoName: 'machineCostCenter', subBuilder: $2.StringValue.create)
    ..aOM<$2.Int32Value>(27, _omitFieldNames ? '' : 'businessClassCode', protoName: 'businessClassCode', subBuilder: $2.Int32Value.create)
    ...
    ..aOM<$2.Int32Value>(33, _omitFieldNames ? '' : 'systemID', protoName: 'systemID', subBuilder: $2.Int32Value.create)
    ..a<$core.int>(34, _omitFieldNames ? '' : 'useFlag', $pb.PbFieldType.OS3, protoName: 'useFlag')
    ..aOM<$2.StringValue>(35, _omitFieldNames ? '' : 'mACAddress', protoName: 'mACAddress', subBuilder: $2.StringValue.create)
    ..aOM<$2.Int32Value>(36, _omitFieldNames ? '' : 'outSourcingType', protoName: 'outSourcingType', subBuilder: $2.Int32Value.create)
  ...
  @$pb.TagNumber(18)
  $2.StringValue get customerCode => $_getN(17);
  @$pb.TagNumber(18)
  set customerCode($2.StringValue v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasCustomerCode() => $_has(17);
  @$pb.TagNumber(18)
  void clearCustomerCode() => clearField(18);
  @$pb.TagNumber(18)
  $2.StringValue ensureCustomerCode() => $_ensure(17);

  @$pb.TagNumber(19)
  $2.Int32Value get opTimeCalculationMethod => $_getN(18);
  @$pb.TagNumber(19)
  set opTimeCalculationMethod($2.Int32Value v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasOpTimeCalculationMethod() => $_has(18);
  @$pb.TagNumber(19)
  void clearOpTimeCalculationMethod() => clearField(19);
  @$pb.TagNumber(19)
  $2.Int32Value ensureOpTimeCalculationMethod() => $_ensure(18);

  @$pb.TagNumber(20)
  $2.Int32Value get locationNo => $_getN(19);
  @$pb.TagNumber(20)
  set locationNo($2.Int32Value v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasLocationNo() => $_has(19);
  @$pb.TagNumber(20)
  void clearLocationNo() => clearField(20);
  @$pb.TagNumber(20)
  $2.Int32Value ensureLocationNo() => $_ensure(19);
  ...
  @$pb.TagNumber(22)
  $2.StringValue get costCenterType => $_getN(21);
  @$pb.TagNumber(22)
  set costCenterType($2.StringValue v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasCostCenterType() => $_has(21);
  @$pb.TagNumber(22)
  void clearCostCenterType() => clearField(22);
  @$pb.TagNumber(22)
  $2.StringValue ensureCostCenterType() => $_ensure(21);
  ...
  @$pb.TagNumber(26)
  $2.StringValue get machineCostCenter => $_getN(25);
  @$pb.TagNumber(26)
  set machineCostCenter($2.StringValue v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasMachineCostCenter() => $_has(25);
  @$pb.TagNumber(26)
  void clearMachineCostCenter() => clearField(26);
  @$pb.TagNumber(26)
  $2.StringValue ensureMachineCostCenter() => $_ensure(25);

  @$pb.TagNumber(27)
  $2.Int32Value get businessClassCode => $_getN(26);
  @$pb.TagNumber(27)
  set businessClassCode($2.Int32Value v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasBusinessClassCode() => $_has(26);
  @$pb.TagNumber(27)
  void clearBusinessClassCode() => clearField(27);
  @$pb.TagNumber(27)
  $2.Int32Value ensureBusinessClassCode() => $_ensure(26);
  ...
  @$pb.TagNumber(33)
  $2.Int32Value get systemID => $_getN(32);
  @$pb.TagNumber(33)
  set systemID($2.Int32Value v) { setField(33, v); }
  @$pb.TagNumber(33)
  $core.bool hasSystemID() => $_has(32);
  @$pb.TagNumber(33)
  void clearSystemID() => clearField(33);
  @$pb.TagNumber(33)
  $2.Int32Value ensureSystemID() => $_ensure(32);
  ...
  @$pb.TagNumber(35)
  $2.StringValue get mACAddress => $_getN(34);
  @$pb.TagNumber(35)
  set mACAddress($2.StringValue v) { setField(35, v); }
  @$pb.TagNumber(35)
  $core.bool hasMACAddress() => $_has(34);
  @$pb.TagNumber(35)
  void clearMACAddress() => clearField(35);
  @$pb.TagNumber(35)
  $2.StringValue ensureMACAddress() => $_ensure(34);

  @$pb.TagNumber(36)
  $2.Int32Value get outSourcingType => $_getN(35);
  @$pb.TagNumber(36)
  set outSourcingType($2.Int32Value v) { setField(36, v); }
  @$pb.TagNumber(36)
  $core.bool hasOutSourcingType() => $_has(35);
  @$pb.TagNumber(36)
  void clearOutSourcingType() => clearField(36);
  @$pb.TagNumber(36)
  $2.Int32Value ensureOutSourcingType() => $_ensure(35);
