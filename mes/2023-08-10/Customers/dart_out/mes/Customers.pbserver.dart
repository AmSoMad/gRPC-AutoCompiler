...
import 'Customers.pb.dart' as $2;
import 'Customers.pbjson.dart';

export 'Customers.pb.dart';

abstract class CustomersServiceBase extends $pb.GeneratedService {
  $async.Future<$2.CustomersResponse> getByKey($pb.ServerContext ctx, $2.GetByKeyRequest request);
  $async.Future<$2.CustomersResponse> getByKeyJson($pb.ServerContext ctx, $2.GetByKeyRequest request);
  $async.Future<$2.CustomersSetResponse> getAll($pb.ServerContext ctx, $1.Empty request);
  $async.Future<$2.CustomersSetResponse> getAllJson($pb.ServerContext ctx, $1.Empty request);
  $async.Future<$2.CustomersResponse> insert($pb.ServerContext ctx, $2.InsertRequest request);
  $async.Future<$2.CustomersResponse> insertJson($pb.ServerContext ctx, $2.InsertRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json => CustomersServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => CustomersServiceBase$messageJson;
}
