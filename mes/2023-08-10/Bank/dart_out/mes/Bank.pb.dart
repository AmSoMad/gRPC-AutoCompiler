...
class BankSetResponse extends $pb.GeneratedMessage {
  factory BankSetResponse() => create();
...
class BankApi {
  ...
  BankApi(this._client);

  $async.Future<BankResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<BankResponse>(ctx, 'Bank', 'GetByKey', request, BankResponse())
  ;
  $async.Future<BankResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<BankResponse>(ctx, 'Bank', 'GetByKeyJson', request, BankResponse())
  ;
  $async.Future<BankSetResponse> getAll($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<BankSetResponse>(ctx, 'Bank', 'GetAll', request, BankSetResponse())
  ;
  $async.Future<BankSetResponse> getAllJson($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<BankSetResponse>(ctx, 'Bank', 'GetAllJson', request, BankSetResponse())
  ;
  $async.Future<BankResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<BankResponse>(ctx, 'Bank', 'Insert', request, BankResponse())
  ;
  $async.Future<BankResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<BankResponse>(ctx, 'Bank', 'InsertJson', request, BankResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'Bank', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'Bank', 'Delete', request, DeleteResponse())
  ;
}
