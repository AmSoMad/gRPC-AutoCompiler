...
import 'CalendarType.pb.dart' as $1;
import 'CalendarType.pbjson.dart';

export 'CalendarType.pb.dart';

abstract class CalendarTypeServiceBase extends $pb.GeneratedService {
  $async.Future<$1.CalendarTypeResponse> getByKey($pb.ServerContext ctx, $1.GetByKeyRequest request);
  $async.Future<$1.CalendarTypeResponse> getByKeyJson($pb.ServerContext ctx, $1.GetByKeyRequest request);
  $async.Future<$1.CalendarTypeSetResponse> getAll($pb.ServerContext ctx, $0.Empty request);
  $async.Future<$1.CalendarTypeSetResponse> getAllJson($pb.ServerContext ctx, $0.Empty request);
  $async.Future<$1.CalendarTypeResponse> insert($pb.ServerContext ctx, $1.InsertRequest request);
  $async.Future<$1.CalendarTypeResponse> insertJson($pb.ServerContext ctx, $1.InsertRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json => CalendarTypeServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => CalendarTypeServiceBase$messageJson;
}
