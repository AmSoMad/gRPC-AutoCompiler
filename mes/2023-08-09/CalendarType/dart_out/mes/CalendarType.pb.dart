...
class CalendarTypeResponse extends $pb.GeneratedMessage {
  factory CalendarTypeResponse() => create();
...
class CalendarTypeSetResponse extends $pb.GeneratedMessage {
  factory CalendarTypeSetResponse() => create();
...
class CalendarTypeApi {
  $pb.RpcClient _client;
  CalendarTypeApi(this._client);

  $async.Future<CalendarTypeResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CalendarTypeResponse>(ctx, 'CalendarType', 'GetByKey', request, CalendarTypeResponse())
  ;
  $async.Future<CalendarTypeResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CalendarTypeResponse>(ctx, 'CalendarType', 'GetByKeyJson', request, CalendarTypeResponse())
  ;
  $async.Future<CalendarTypeSetResponse> getAll($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<CalendarTypeSetResponse>(ctx, 'CalendarType', 'GetAll', request, CalendarTypeSetResponse())
  ;
  $async.Future<CalendarTypeSetResponse> getAllJson($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<CalendarTypeSetResponse>(ctx, 'CalendarType', 'GetAllJson', request, CalendarTypeSetResponse())
  ;
  $async.Future<CalendarTypeResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CalendarTypeResponse>(ctx, 'CalendarType', 'Insert', request, CalendarTypeResponse())
  ;
  $async.Future<CalendarTypeResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CalendarTypeResponse>(ctx, 'CalendarType', 'InsertJson', request, CalendarTypeResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'CalendarType', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'CalendarType', 'Delete', request, DeleteResponse())
  ;
}
