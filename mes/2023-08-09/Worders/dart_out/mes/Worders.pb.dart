...
class WordersResponse extends $pb.GeneratedMessage {
  factory WordersResponse() => create();
...
class WordersSetResponse extends $pb.GeneratedMessage {
  factory WordersSetResponse() => create();
...
class GetForWorkersRequest extends $pb.GeneratedMessage {
  factory GetForWorkersRequest() => create();
...
class GetForRoutesRequest extends $pb.GeneratedMessage {
  factory GetForRoutesRequest() => create();
...
class InsertRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'WordersSvc'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(4, _omitFieldNames ? '' : 'originalStartDate', protoName: 'originalStartDate', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(5, _omitFieldNames ? '' : 'originalDueDate', protoName: 'originalDueDate', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(6, _omitFieldNames ? '' : 'actualStartDate', protoName: 'actualStartDate', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(7, _omitFieldNames ? '' : 'actualDueDate', protoName: 'actualDueDate', subBuilder: $0.Timestamp.create)
    ...
    ..aOM<$1.Int32Value>(22, _omitFieldNames ? '' : 'businessClassCode', protoName: 'businessClassCode', subBuilder: $1.Int32Value.create)
    ..aOM<$1.StringValue>(23, _omitFieldNames ? '' : 'originalWorksOrderNo', protoName: 'originalWorksOrderNo', subBuilder: $1.StringValue.create)
    ..aOM<$1.StringValue>(24, _omitFieldNames ? '' : 'remarks', subBuilder: $1.StringValue.create)
    ..aOM<$1.StringValue>(25, _omitFieldNames ? '' : 'customerCode', protoName: 'customerCode', subBuilder: $1.StringValue.create)
    ..a<$core.int>(26, _omitFieldNames ? '' : 'wOrderType', $pb.PbFieldType.OS3, protoName: 'wOrderType')
    ..aOM<$1.StringValue>(27, _omitFieldNames ? '' : 'workerCode', protoName: 'workerCode', subBuilder: $1.StringValue.create)
    ..aOM<$1.StringValue>(28, _omitFieldNames ? '' : 'route', subBuilder: $1.StringValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $0.Timestamp get originalStartDate => $_getN(3);
  @$pb.TagNumber(4)
  set originalStartDate($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasOriginalStartDate() => $_has(3);
  @$pb.TagNumber(4)
  void clearOriginalStartDate() => clearField(4);
  @$pb.TagNumber(4)
  $0.Timestamp ensureOriginalStartDate() => $_ensure(3);

  @$pb.TagNumber(5)
  $0.Timestamp get originalDueDate => $_getN(4);
  @$pb.TagNumber(5)
  set originalDueDate($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasOriginalDueDate() => $_has(4);
  @$pb.TagNumber(5)
  void clearOriginalDueDate() => clearField(5);
  @$pb.TagNumber(5)
  $0.Timestamp ensureOriginalDueDate() => $_ensure(4);

  @$pb.TagNumber(6)
  $0.Timestamp get actualStartDate => $_getN(5);
  @$pb.TagNumber(6)
  set actualStartDate($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasActualStartDate() => $_has(5);
  @$pb.TagNumber(6)
  void clearActualStartDate() => clearField(6);
  @$pb.TagNumber(6)
  $0.Timestamp ensureActualStartDate() => $_ensure(5);

  @$pb.TagNumber(7)
  $0.Timestamp get actualDueDate => $_getN(6);
  @$pb.TagNumber(7)
  set actualDueDate($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasActualDueDate() => $_has(6);
  @$pb.TagNumber(7)
  void clearActualDueDate() => clearField(7);
  @$pb.TagNumber(7)
  $0.Timestamp ensureActualDueDate() => $_ensure(6);
  ...
  @$pb.TagNumber(22)
  $1.Int32Value get businessClassCode => $_getN(21);
  @$pb.TagNumber(22)
  set businessClassCode($1.Int32Value v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasBusinessClassCode() => $_has(21);
  @$pb.TagNumber(22)
  void clearBusinessClassCode() => clearField(22);
  @$pb.TagNumber(22)
  $1.Int32Value ensureBusinessClassCode() => $_ensure(21);

  @$pb.TagNumber(23)
  $1.StringValue get originalWorksOrderNo => $_getN(22);
  @$pb.TagNumber(23)
  set originalWorksOrderNo($1.StringValue v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasOriginalWorksOrderNo() => $_has(22);
  @$pb.TagNumber(23)
  void clearOriginalWorksOrderNo() => clearField(23);
  @$pb.TagNumber(23)
  $1.StringValue ensureOriginalWorksOrderNo() => $_ensure(22);

  @$pb.TagNumber(24)
  $1.StringValue get remarks => $_getN(23);
  @$pb.TagNumber(24)
  set remarks($1.StringValue v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasRemarks() => $_has(23);
  @$pb.TagNumber(24)
  void clearRemarks() => clearField(24);
  @$pb.TagNumber(24)
  $1.StringValue ensureRemarks() => $_ensure(23);

  @$pb.TagNumber(25)
  $1.StringValue get customerCode => $_getN(24);
  @$pb.TagNumber(25)
  set customerCode($1.StringValue v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasCustomerCode() => $_has(24);
  @$pb.TagNumber(25)
  void clearCustomerCode() => clearField(25);
  @$pb.TagNumber(25)
  $1.StringValue ensureCustomerCode() => $_ensure(24);
  ...
  @$pb.TagNumber(27)
  $1.StringValue get workerCode => $_getN(26);
  @$pb.TagNumber(27)
  set workerCode($1.StringValue v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasWorkerCode() => $_has(26);
  @$pb.TagNumber(27)
  void clearWorkerCode() => clearField(27);
  @$pb.TagNumber(27)
  $1.StringValue ensureWorkerCode() => $_ensure(26);

  @$pb.TagNumber(28)
  $1.StringValue get route => $_getN(27);
  @$pb.TagNumber(28)
  set route($1.StringValue v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasRoute() => $_has(27);
  @$pb.TagNumber(28)
  void clearRoute() => clearField(28);
  @$pb.TagNumber(28)
  $1.StringValue ensureRoute() => $_ensure(27);
}
...
class WordersApi {
  ...
  WordersApi(this._client);

  $async.Future<WordersSetResponse> getForBusinessClass_Sale($pb.ClientContext? ctx, GetForBusinessClass_SaleRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForBusinessClass_Sale', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getForBusinessClass_SaleJson($pb.ClientContext? ctx, GetForBusinessClass_SaleRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForBusinessClass_SaleJson', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getForCustomers($pb.ClientContext? ctx, GetForCustomersRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForCustomers', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getForCustomersJson($pb.ClientContext? ctx, GetForCustomersRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForCustomersJson', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getForWorkers($pb.ClientContext? ctx, GetForWorkersRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForWorkers', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getForWorkersJson($pb.ClientContext? ctx, GetForWorkersRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForWorkersJson', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getForRoutes($pb.ClientContext? ctx, GetForRoutesRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForRoutes', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getForRoutesJson($pb.ClientContext? ctx, GetForRoutesRequest request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetForRoutesJson', request, WordersSetResponse())
  ;
  $async.Future<WordersResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<WordersResponse>(ctx, 'Worders', 'GetByKey', request, WordersResponse())
  ;
  $async.Future<WordersResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<WordersResponse>(ctx, 'Worders', 'GetByKeyJson', request, WordersResponse())
  ;
  $async.Future<WordersSetResponse> getAll($pb.ClientContext? ctx, $2.Empty request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetAll', request, WordersSetResponse())
  ;
  $async.Future<WordersSetResponse> getAllJson($pb.ClientContext? ctx, $2.Empty request) =>
    _client.invoke<WordersSetResponse>(ctx, 'Worders', 'GetAllJson', request, WordersSetResponse())
  ;
  $async.Future<WordersResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<WordersResponse>(ctx, 'Worders', 'Insert', request, WordersResponse())
  ;
  $async.Future<WordersResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<WordersResponse>(ctx, 'Worders', 'InsertJson', request, WordersResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'Worders', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'Worders', 'Delete', request, DeleteResponse())
  ;
}
