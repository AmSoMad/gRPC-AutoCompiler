...
class BusinessClassResponse extends $pb.GeneratedMessage {
  factory BusinessClassResponse() => create();
...
class BusinessClassSetResponse extends $pb.GeneratedMessage {
  factory BusinessClassSetResponse() => create();
...
class GetForCompanyInformationRequest extends $pb.GeneratedMessage {
  factory GetForCompanyInformationRequest() => create();
...
class InsertRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'BusinessClassSvc'), createEmptyInstance: create)
    ...
    ..oo(2, [20])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'businessClassCode', $pb.PbFieldType.OS3, protoName: 'businessClassCode')
    ..aOM<$0.StringValue>(2, _omitFieldNames ? '' : 'zipCode', protoName: 'zipCode', subBuilder: $0.StringValue.create)
    ...
    ..aOM<$0.StringValue>(7, _omitFieldNames ? '' : 'corporationNo', protoName: 'corporationNo', subBuilder: $0.StringValue.create)
    ..aOS(8, _omitFieldNames ? '' : 'businessCode', protoName: 'businessCode')
    ..aOM<$0.StringValue>(9, _omitFieldNames ? '' : 'president', subBuilder: $0.StringValue.create)
    ..aOS(10, _omitFieldNames ? '' : 'businessItem', protoName: 'businessItem')
    ..aOS(11, _omitFieldNames ? '' : 'businessType', protoName: 'businessType')
    ..aOM<$0.StringValue>(12, _omitFieldNames ? '' : 'phone', subBuilder: $0.StringValue.create)
    ...
    ..aOM<$0.Int32Value>(16, _omitFieldNames ? '' : 'companyType', protoName: 'companyType', subBuilder: $0.Int32Value.create)
    ..aOM<$1.Timestamp>(17, _omitFieldNames ? '' : 'setupDate', protoName: 'setupDate', subBuilder: $1.Timestamp.create)
    ...
    ..aOM<$0.StringValue>(21, _omitFieldNames ? '' : 'lCNSNO', protoName: 'lCNSNO', subBuilder: $0.StringValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $0.StringValue get zipCode => $_getN(1);
  @$pb.TagNumber(2)
  set zipCode($0.StringValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasZipCode() => $_has(1);
  @$pb.TagNumber(2)
  void clearZipCode() => clearField(2);
  @$pb.TagNumber(2)
  $0.StringValue ensureZipCode() => $_ensure(1);
  ...
  @$pb.TagNumber(7)
  $0.StringValue get corporationNo => $_getN(6);
  @$pb.TagNumber(7)
  set corporationNo($0.StringValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCorporationNo() => $_has(6);
  @$pb.TagNumber(7)
  void clearCorporationNo() => clearField(7);
  @$pb.TagNumber(7)
  $0.StringValue ensureCorporationNo() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $0.StringValue get president => $_getN(8);
  @$pb.TagNumber(9)
  set president($0.StringValue v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasPresident() => $_has(8);
  @$pb.TagNumber(9)
  void clearPresident() => clearField(9);
  @$pb.TagNumber(9)
  $0.StringValue ensurePresident() => $_ensure(8);
  ...
  @$pb.TagNumber(12)
  $0.StringValue get phone => $_getN(11);
  @$pb.TagNumber(12)
  set phone($0.StringValue v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasPhone() => $_has(11);
  @$pb.TagNumber(12)
  void clearPhone() => clearField(12);
  @$pb.TagNumber(12)
  $0.StringValue ensurePhone() => $_ensure(11);
  ...
  @$pb.TagNumber(16)
  $0.Int32Value get companyType => $_getN(15);
  @$pb.TagNumber(16)
  set companyType($0.Int32Value v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasCompanyType() => $_has(15);
  @$pb.TagNumber(16)
  void clearCompanyType() => clearField(16);
  @$pb.TagNumber(16)
  $0.Int32Value ensureCompanyType() => $_ensure(15);

  @$pb.TagNumber(17)
  $1.Timestamp get setupDate => $_getN(16);
  @$pb.TagNumber(17)
  set setupDate($1.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasSetupDate() => $_has(16);
  @$pb.TagNumber(17)
  void clearSetupDate() => clearField(17);
  @$pb.TagNumber(17)
  $1.Timestamp ensureSetupDate() => $_ensure(16);
  ...
  @$pb.TagNumber(21)
  $0.StringValue get lCNSNO => $_getN(20);
  @$pb.TagNumber(21)
  set lCNSNO($0.StringValue v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasLCNSNO() => $_has(20);
  @$pb.TagNumber(21)
  void clearLCNSNO() => clearField(21);
  @$pb.TagNumber(21)
  $0.StringValue ensureLCNSNO() => $_ensure(20);
}
...
class BusinessClassApi {
  ...
  BusinessClassApi(this._client);

  $async.Future<BusinessClassSetResponse> getForCompanyInformation($pb.ClientContext? ctx, GetForCompanyInformationRequest request) =>
    _client.invoke<BusinessClassSetResponse>(ctx, 'BusinessClass', 'GetForCompanyInformation', request, BusinessClassSetResponse())
  ;
  $async.Future<BusinessClassSetResponse> getForCompanyInformationJson($pb.ClientContext? ctx, GetForCompanyInformationRequest request) =>
    _client.invoke<BusinessClassSetResponse>(ctx, 'BusinessClass', 'GetForCompanyInformationJson', request, BusinessClassSetResponse())
  ;
  $async.Future<BusinessClassResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<BusinessClassResponse>(ctx, 'BusinessClass', 'GetByKey', request, BusinessClassResponse())
  ;
  $async.Future<BusinessClassResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<BusinessClassResponse>(ctx, 'BusinessClass', 'GetByKeyJson', request, BusinessClassResponse())
  ;
  $async.Future<BusinessClassSetResponse> getAll($pb.ClientContext? ctx, $2.Empty request) =>
    _client.invoke<BusinessClassSetResponse>(ctx, 'BusinessClass', 'GetAll', request, BusinessClassSetResponse())
  ;
  $async.Future<BusinessClassSetResponse> getAllJson($pb.ClientContext? ctx, $2.Empty request) =>
    _client.invoke<BusinessClassSetResponse>(ctx, 'BusinessClass', 'GetAllJson', request, BusinessClassSetResponse())
  ;
  $async.Future<BusinessClassResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<BusinessClassResponse>(ctx, 'BusinessClass', 'Insert', request, BusinessClassResponse())
  ;
  $async.Future<BusinessClassResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<BusinessClassResponse>(ctx, 'BusinessClass', 'InsertJson', request, BusinessClassResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'BusinessClass', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'BusinessClass', 'Delete', request, DeleteResponse())
  ;
}
