...
class AssetsTypesResponse extends $pb.GeneratedMessage {
  factory AssetsTypesResponse() => create();
...
class AssetsTypesSetResponse extends $pb.GeneratedMessage {
  factory AssetsTypesSetResponse() => create();
...
class AssetsTypesApi {
  $pb.RpcClient _client;
  AssetsTypesApi(this._client);

  $async.Future<AssetsTypesResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<AssetsTypesResponse>(ctx, 'AssetsTypes', 'GetByKey', request, AssetsTypesResponse())
  ;
  $async.Future<AssetsTypesResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<AssetsTypesResponse>(ctx, 'AssetsTypes', 'GetByKeyJson', request, AssetsTypesResponse())
  ;
  $async.Future<AssetsTypesSetResponse> getAll($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<AssetsTypesSetResponse>(ctx, 'AssetsTypes', 'GetAll', request, AssetsTypesSetResponse())
  ;
  $async.Future<AssetsTypesSetResponse> getAllJson($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<AssetsTypesSetResponse>(ctx, 'AssetsTypes', 'GetAllJson', request, AssetsTypesSetResponse())
  ;
  $async.Future<AssetsTypesResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<AssetsTypesResponse>(ctx, 'AssetsTypes', 'Insert', request, AssetsTypesResponse())
  ;
  $async.Future<AssetsTypesResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<AssetsTypesResponse>(ctx, 'AssetsTypes', 'InsertJson', request, AssetsTypesResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'AssetsTypes', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'AssetsTypes', 'Delete', request, DeleteResponse())
  ;
}
