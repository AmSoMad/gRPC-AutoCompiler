...
import 'Commodity.pb.dart' as $2;
import 'Commodity.pbjson.dart';

export 'Commodity.pb.dart';

abstract class CommodityServiceBase extends $pb.GeneratedService {
  $async.Future<$2.CommodityResponse> getByKey($pb.ServerContext ctx, $2.GetByKeyRequest request);
  $async.Future<$2.CommodityResponse> getByKeyJson($pb.ServerContext ctx, $2.GetByKeyRequest request);
  $async.Future<$2.CommoditySetResponse> getAll($pb.ServerContext ctx, $1.Empty request);
  $async.Future<$2.CommoditySetResponse> getAllJson($pb.ServerContext ctx, $1.Empty request);
  $async.Future<$2.CommodityResponse> insert($pb.ServerContext ctx, $2.InsertRequest request);
  $async.Future<$2.CommodityResponse> insertJson($pb.ServerContext ctx, $2.InsertRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json => CommodityServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => CommodityServiceBase$messageJson;
}
