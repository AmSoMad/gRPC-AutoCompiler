...
class CommodityResponse extends $pb.GeneratedMessage {
  factory CommodityResponse() => create();
...
class CommoditySetResponse extends $pb.GeneratedMessage {
  factory CommoditySetResponse() => create();
...
class InsertRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsertRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'CommoditySvc'), createEmptyInstance: create)
    ...
    ..aOM<$0.Int32Value>(3, _omitFieldNames ? '' : 'useInventoryInformation', protoName: 'useInventoryInformation', subBuilder: $0.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $0.Int32Value get useInventoryInformation => $_getN(2);
  @$pb.TagNumber(3)
  set useInventoryInformation($0.Int32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUseInventoryInformation() => $_has(2);
  @$pb.TagNumber(3)
  void clearUseInventoryInformation() => clearField(3);
  @$pb.TagNumber(3)
  $0.Int32Value ensureUseInventoryInformation() => $_ensure(2);
}
...
class CommodityApi {
  ...
  CommodityApi(this._client);

  $async.Future<CommodityResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CommodityResponse>(ctx, 'Commodity', 'GetByKey', request, CommodityResponse())
  ;
  $async.Future<CommodityResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CommodityResponse>(ctx, 'Commodity', 'GetByKeyJson', request, CommodityResponse())
  ;
  $async.Future<CommoditySetResponse> getAll($pb.ClientContext? ctx, $1.Empty request) =>
    _client.invoke<CommoditySetResponse>(ctx, 'Commodity', 'GetAll', request, CommoditySetResponse())
  ;
  $async.Future<CommoditySetResponse> getAllJson($pb.ClientContext? ctx, $1.Empty request) =>
    _client.invoke<CommoditySetResponse>(ctx, 'Commodity', 'GetAllJson', request, CommoditySetResponse())
  ;
  $async.Future<CommodityResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CommodityResponse>(ctx, 'Commodity', 'Insert', request, CommodityResponse())
  ;
  $async.Future<CommodityResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CommodityResponse>(ctx, 'Commodity', 'InsertJson', request, CommodityResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'Commodity', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'Commodity', 'Delete', request, DeleteResponse())
  ;
}
