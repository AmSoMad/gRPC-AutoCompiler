...
import 'Bank.pbjson.dart';

export 'Bank.pb.dart';

abstract class BankServiceBase extends $pb.GeneratedService {
  $async.Future<$1.BankResponse> getByKey($pb.ServerContext ctx, $1.GetByKeyRequest request);
  $async.Future<$1.BankResponse> getByKeyJson($pb.ServerContext ctx, $1.GetByKeyRequest request);
  $async.Future<$1.BankSetResponse> getAll($pb.ServerContext ctx, $0.Empty request);
  $async.Future<$1.BankSetResponse> getAllJson($pb.ServerContext ctx, $0.Empty request);
  $async.Future<$1.BankResponse> insert($pb.ServerContext ctx, $1.InsertRequest request);
  $async.Future<$1.BankResponse> insertJson($pb.ServerContext ctx, $1.InsertRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json => BankServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => BankServiceBase$messageJson;
}
