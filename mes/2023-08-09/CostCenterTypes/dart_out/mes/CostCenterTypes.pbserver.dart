...
import 'CostCenterTypes.pb.dart' as $1;
import 'CostCenterTypes.pbjson.dart';

export 'CostCenterTypes.pb.dart';

abstract class CostCenterTypesServiceBase extends $pb.GeneratedService {
  $async.Future<$1.CostCenterTypesResponse> getByKey($pb.ServerContext ctx, $1.GetByKeyRequest request);
  $async.Future<$1.CostCenterTypesResponse> getByKeyJson($pb.ServerContext ctx, $1.GetByKeyRequest request);
  $async.Future<$1.CostCenterTypesSetResponse> getAll($pb.ServerContext ctx, $0.Empty request);
  $async.Future<$1.CostCenterTypesSetResponse> getAllJson($pb.ServerContext ctx, $0.Empty request);
  $async.Future<$1.CostCenterTypesResponse> insert($pb.ServerContext ctx, $1.InsertRequest request);
  $async.Future<$1.CostCenterTypesResponse> insertJson($pb.ServerContext ctx, $1.InsertRequest request);
  ...
  $core.Map<$core.String, $core.dynamic> get $json => CostCenterTypesServiceBase$json;
  $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> get $messageJson => CostCenterTypesServiceBase$messageJson;
}
