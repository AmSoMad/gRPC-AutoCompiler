...
class CostCenterTypesResponse extends $pb.GeneratedMessage {
  factory CostCenterTypesResponse() => create();
...
class CostCenterTypesSetResponse extends $pb.GeneratedMessage {
  factory CostCenterTypesSetResponse() => create();
...
class CostCenterTypesApi {
  $pb.RpcClient _client;
  CostCenterTypesApi(this._client);

  $async.Future<CostCenterTypesResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CostCenterTypesResponse>(ctx, 'CostCenterTypes', 'GetByKey', request, CostCenterTypesResponse())
  ;
  $async.Future<CostCenterTypesResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CostCenterTypesResponse>(ctx, 'CostCenterTypes', 'GetByKeyJson', request, CostCenterTypesResponse())
  ;
  $async.Future<CostCenterTypesSetResponse> getAll($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<CostCenterTypesSetResponse>(ctx, 'CostCenterTypes', 'GetAll', request, CostCenterTypesSetResponse())
  ;
  $async.Future<CostCenterTypesSetResponse> getAllJson($pb.ClientContext? ctx, $0.Empty request) =>
    _client.invoke<CostCenterTypesSetResponse>(ctx, 'CostCenterTypes', 'GetAllJson', request, CostCenterTypesSetResponse())
  ;
  $async.Future<CostCenterTypesResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CostCenterTypesResponse>(ctx, 'CostCenterTypes', 'Insert', request, CostCenterTypesResponse())
  ;
  $async.Future<CostCenterTypesResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CostCenterTypesResponse>(ctx, 'CostCenterTypes', 'InsertJson', request, CostCenterTypesResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'CostCenterTypes', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'CostCenterTypes', 'Delete', request, DeleteResponse())
  ;
}
