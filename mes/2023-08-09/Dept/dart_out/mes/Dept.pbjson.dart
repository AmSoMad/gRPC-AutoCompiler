...
const $core.Map<$core.String, $core.dynamic> DeptServiceBase$json = {
  '1': 'Dept',
  '2': [
    {'1': 'GetForExpenseAccount', '2': '.DeptSvc.GetForExpenseAccountRequest', '3': '.DeptSvc.DeptSetResponse'},
    {'1': 'GetForExpenseAccountJson', '2': '.DeptSvc.GetForExpenseAccountRequest', '3': '.DeptSvc.DeptSetResponse'},
    {'1': 'GetForBusinessClass', '2': '.DeptSvc.GetForBusinessClassRequest', '3': '.DeptSvc.DeptSetResponse'},
    {'1': 'GetForBusinessClassJson', '2': '.DeptSvc.GetForBusinessClassRequest', '3': '.DeptSvc.DeptSetResponse'},
    {'1': 'GetByKey', '2': '.DeptSvc.GetByKeyRequest', '3': '.DeptSvc.DeptResponse'},
    {'1': 'GetByKeyJson', '2': '.DeptSvc.GetByKeyRequest', '3': '.DeptSvc.DeptResponse'},
    {'1': 'GetAll', '2': '.google.protobuf.Empty', '3': '.DeptSvc.DeptSetResponse'},
    {'1': 'GetAllJson', '2': '.google.protobuf.Empty', '3': '.DeptSvc.DeptSetResponse'},
    {'1': 'Insert', '2': '.DeptSvc.InsertRequest', '3': '.DeptSvc.DeptResponse'},
    {'1': 'InsertJson', '2': '.DeptSvc.InsertRequest', '3': '.DeptSvc.DeptResponse'},
    {'1': 'Update', '2': '.DeptSvc.UpdateRequest', '3': '.DeptSvc.UpdateResponse'},
    {'1': 'Delete', '2': '.DeptSvc.DeleteRequest', '3': '.DeptSvc.DeleteResponse'},
  ],
};

@$core.Deprecated('Use deptServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> DeptServiceBase$messageJson = {
  '.DeptSvc.GetForExpenseAccountRequest': GetForExpenseAccountRequest$json,
  '.DeptSvc.DeptSetResponse': DeptSetResponse$json,
  '.DeptSvc.GetForBusinessClassRequest': GetForBusinessClassRequest$json,
  '.DeptSvc.GetByKeyRequest': GetByKeyRequest$json,
  '.DeptSvc.DeptResponse': DeptResponse$json,
  '.google.protobuf.Empty': $1.Empty$json,
  '.DeptSvc.InsertRequest': InsertRequest$json,
  '.google.protobuf.Int32Value': $0.Int32Value$json,
  '.google.protobuf.StringValue': $0.StringValue$json,
  '.DeptSvc.UpdateRequest': UpdateRequest$json,
  '.DeptSvc.UpdateResponse': UpdateResponse$json,
  '.DeptSvc.DeleteRequest': DeleteRequest$json,
  '.DeptSvc.DeleteResponse': DeleteResponse$json,
};

/// Descriptor for `Dept`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List deptServiceDescriptor = $convert.base64Decode(
    'CgREZXB0ElYKFEdldEZvckV4cGVuc2VBY2NvdW50EiQuRGVwdFN2Yy5HZXRGb3JFeHBlbnNlQW'
    'Njb3VudFJlcXVlc3QaGC5EZXB0U3ZjLkRlcHRTZXRSZXNwb25zZRJaChhHZXRGb3JFeHBlbnNl'
    'QWNjb3VudEpzb24SJC5EZXB0U3ZjLkdldEZvckV4cGVuc2VBY2NvdW50UmVxdWVzdBoYLkRlcH'
    'RTdmMuRGVwdFNldFJlc3BvbnNlElQKE0dldEZvckJ1c2luZXNzQ2xhc3MSIy5EZXB0U3ZjLkdl'
    'dEZvckJ1c2luZXNzQ2xhc3NSZXF1ZXN0GhguRGVwdFN2Yy5EZXB0U2V0UmVzcG9uc2USWAoXR2'
    'V0Rm9yQnVzaW5lc3NDbGFzc0pzb24SIy5EZXB0U3ZjLkdldEZvckJ1c2luZXNzQ2xhc3NSZXF1'
    'ZXN0GhguRGVwdFN2Yy5EZXB0U2V0UmVzcG9uc2USOwoIR2V0QnlLZXkSGC5EZXB0U3ZjLkdldE'
    'J5S2V5UmVxdWVzdBoVLkRlcHRTdmMuRGVwdFJlc3BvbnNlEj8KDEdldEJ5S2V5SnNvbhIYLkRl'
    'cHRTdmMuR2V0QnlLZXlSZXF1ZXN0GhUuRGVwdFN2Yy5EZXB0UmVzcG9uc2USOgoGR2V0QWxsEh'
    'YuZ29vZ2xlLnByb3RvYnVmLkVtcHR5GhguRGVwdFN2Yy5EZXB0U2V0UmVzcG9uc2USPgoKR2V0'
    'QWxsSnNvbhIWLmdvb2dsZS5wcm90b2J1Zi5FbXB0eRoYLkRlcHRTdmMuRGVwdFNldFJlc3Bvbn'
    'NlEjcKBkluc2VydBIWLkRlcHRTdmMuSW5zZXJ0UmVxdWVzdBoVLkRlcHRTdmMuRGVwdFJlc3Bv'
    'bnNlEjsKCkluc2VydEpzb24SFi5EZXB0U3ZjLkluc2VydFJlcXVlc3QaFS5EZXB0U3ZjLkRlcH'
    'RSZXNwb25zZRI5CgZVcGRhdGUSFi5EZXB0U3ZjLlVwZGF0ZVJlcXVlc3QaFy5EZXB0U3ZjLlVw'
    'ZGF0ZVJlc3BvbnNlEjkKBkRlbGV0ZRIWLkRlcHRTdmMuRGVsZXRlUmVxdWVzdBoXLkRlcHRTdm'
    'MuRGVsZXRlUmVzcG9uc2U=');
