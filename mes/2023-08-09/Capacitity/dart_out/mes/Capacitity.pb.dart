...
class CapacitityResponse extends $pb.GeneratedMessage {
  factory CapacitityResponse() => create();
...
class CapacititySetResponse extends $pb.GeneratedMessage {
  factory CapacititySetResponse() => create();
...
class GetForCostCentersRequest extends $pb.GeneratedMessage {
  factory GetForCostCentersRequest() => create();
...
class CapacitityApi {
  ...
  CapacitityApi(this._client);

  $async.Future<CapacititySetResponse> getForCostCenters($pb.ClientContext? ctx, GetForCostCentersRequest request) =>
    _client.invoke<CapacititySetResponse>(ctx, 'Capacitity', 'GetForCostCenters', request, CapacititySetResponse())
  ;
  $async.Future<CapacititySetResponse> getForCostCentersJson($pb.ClientContext? ctx, GetForCostCentersRequest request) =>
    _client.invoke<CapacititySetResponse>(ctx, 'Capacitity', 'GetForCostCentersJson', request, CapacititySetResponse())
  ;
  $async.Future<CapacitityResponse> getByKey($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CapacitityResponse>(ctx, 'Capacitity', 'GetByKey', request, CapacitityResponse())
  ;
  $async.Future<CapacitityResponse> getByKeyJson($pb.ClientContext? ctx, GetByKeyRequest request) =>
    _client.invoke<CapacitityResponse>(ctx, 'Capacitity', 'GetByKeyJson', request, CapacitityResponse())
  ;
  $async.Future<CapacititySetResponse> getAll($pb.ClientContext? ctx, $1.Empty request) =>
    _client.invoke<CapacititySetResponse>(ctx, 'Capacitity', 'GetAll', request, CapacititySetResponse())
  ;
  $async.Future<CapacititySetResponse> getAllJson($pb.ClientContext? ctx, $1.Empty request) =>
    _client.invoke<CapacititySetResponse>(ctx, 'Capacitity', 'GetAllJson', request, CapacititySetResponse())
  ;
  $async.Future<CapacitityResponse> insert($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CapacitityResponse>(ctx, 'Capacitity', 'Insert', request, CapacitityResponse())
  ;
  $async.Future<CapacitityResponse> insertJson($pb.ClientContext? ctx, InsertRequest request) =>
    _client.invoke<CapacitityResponse>(ctx, 'Capacitity', 'InsertJson', request, CapacitityResponse())
  ;
  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'Capacitity', 'Update', request, UpdateResponse())
  ;
  $async.Future<DeleteResponse> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<DeleteResponse>(ctx, 'Capacitity', 'Delete', request, DeleteResponse())
  ;
}
