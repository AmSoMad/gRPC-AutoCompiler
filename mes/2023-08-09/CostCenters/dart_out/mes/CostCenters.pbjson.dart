...
const $core.Map<$core.String, $core.dynamic> CostCentersServiceBase$json = {
  '1': 'CostCenters',
  '2': [
    {'1': 'GetForCalendarType', '2': '.CostCentersSvc.GetForCalendarTypeRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForCalendarTypeJson', '2': '.CostCentersSvc.GetForCalendarTypeRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForCustomers', '2': '.CostCentersSvc.GetForCustomersRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForCustomersJson', '2': '.CostCentersSvc.GetForCustomersRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForLocation', '2': '.CostCentersSvc.GetForLocationRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForLocationJson', '2': '.CostCentersSvc.GetForLocationRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForCostCenterTypes', '2': '.CostCentersSvc.GetForCostCenterTypesRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForCostCenterTypesJson', '2': '.CostCentersSvc.GetForCostCenterTypesRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForBusinessClass_Sale', '2': '.CostCentersSvc.GetForBusinessClass_SaleRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForBusinessClass_SaleJson', '2': '.CostCentersSvc.GetForBusinessClass_SaleRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForInspectionSystems', '2': '.CostCentersSvc.GetForInspectionSystemsRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForInspectionSystemsJson', '2': '.CostCentersSvc.GetForInspectionSystemsRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForMeasureUnit', '2': '.CostCentersSvc.GetForMeasureUnitRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetForMeasureUnitJson', '2': '.CostCentersSvc.GetForMeasureUnitRequest', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetByKey', '2': '.CostCentersSvc.GetByKeyRequest', '3': '.CostCentersSvc.CostCentersResponse'},
    {'1': 'GetByKeyJson', '2': '.CostCentersSvc.GetByKeyRequest', '3': '.CostCentersSvc.CostCentersResponse'},
    {'1': 'GetAll', '2': '.google.protobuf.Empty', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'GetAllJson', '2': '.google.protobuf.Empty', '3': '.CostCentersSvc.CostCentersSetResponse'},
    {'1': 'Insert', '2': '.CostCentersSvc.InsertRequest', '3': '.CostCentersSvc.CostCentersResponse'},
    {'1': 'InsertJson', '2': '.CostCentersSvc.InsertRequest', '3': '.CostCentersSvc.CostCentersResponse'},
    {'1': 'Update', '2': '.CostCentersSvc.UpdateRequest', '3': '.CostCentersSvc.UpdateResponse'},
    {'1': 'Delete', '2': '.CostCentersSvc.DeleteRequest', '3': '.CostCentersSvc.DeleteResponse'},
  ],
};

@$core.Deprecated('Use costCentersServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> CostCentersServiceBase$messageJson = {
  '.CostCentersSvc.GetForCalendarTypeRequest': GetForCalendarTypeRequest$json,
  '.CostCentersSvc.CostCentersSetResponse': CostCentersSetResponse$json,
  '.CostCentersSvc.GetForCustomersRequest': GetForCustomersRequest$json,
  '.CostCentersSvc.GetForLocationRequest': GetForLocationRequest$json,
  '.CostCentersSvc.GetForCostCenterTypesRequest': GetForCostCenterTypesRequest$json,
  '.CostCentersSvc.GetForBusinessClass_SaleRequest': GetForBusinessClass_SaleRequest$json,
  '.CostCentersSvc.GetForInspectionSystemsRequest': GetForInspectionSystemsRequest$json,
  '.CostCentersSvc.GetForMeasureUnitRequest': GetForMeasureUnitRequest$json,
  '.CostCentersSvc.GetByKeyRequest': GetByKeyRequest$json,
  '.CostCentersSvc.CostCentersResponse': CostCentersResponse$json,
  '.google.protobuf.Empty': $1.Empty$json,
  '.CostCentersSvc.InsertRequest': InsertRequest$json,
  '.CostCentersSvc.GrpcDecimal': GrpcDecimal$json,
  '.google.protobuf.StringValue': $0.StringValue$json,
  '.google.protobuf.Int32Value': $0.Int32Value$json,
  '.CostCentersSvc.UpdateRequest': UpdateRequest$json,
  '.CostCentersSvc.UpdateResponse': UpdateResponse$json,
  '.CostCentersSvc.DeleteRequest': DeleteRequest$json,
  '.CostCentersSvc.DeleteResponse': DeleteResponse$json,
};

/// Descriptor for `CostCenters`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List costCentersServiceDescriptor = $convert.base64Decode(
    'CgtDb3N0Q2VudGVycxJnChJHZXRGb3JDYWxlbmRhclR5cGUSKS5Db3N0Q2VudGVyc1N2Yy5HZX'
    'RGb3JDYWxlbmRhclR5cGVSZXF1ZXN0GiYuQ29zdENlbnRlcnNTdmMuQ29zdENlbnRlcnNTZXRS'
    'ZXNwb25zZRJrChZHZXRGb3JDYWxlbmRhclR5cGVKc29uEikuQ29zdENlbnRlcnNTdmMuR2V0Rm'
    '9yQ2FsZW5kYXJUeXBlUmVxdWVzdBomLkNvc3RDZW50ZXJzU3ZjLkNvc3RDZW50ZXJzU2V0UmVz'
    'cG9uc2USYQoPR2V0Rm9yQ3VzdG9tZXJzEiYuQ29zdENlbnRlcnNTdmMuR2V0Rm9yQ3VzdG9tZX'
    'JzUmVxdWVzdBomLkNvc3RDZW50ZXJzU3ZjLkNvc3RDZW50ZXJzU2V0UmVzcG9uc2USZQoTR2V0'
    'Rm9yQ3VzdG9tZXJzSnNvbhImLkNvc3RDZW50ZXJzU3ZjLkdldEZvckN1c3RvbWVyc1JlcXVlc3'
    'QaJi5Db3N0Q2VudGVyc1N2Yy5Db3N0Q2VudGVyc1NldFJlc3BvbnNlEl8KDkdldEZvckxvY2F0'
    'aW9uEiUuQ29zdENlbnRlcnNTdmMuR2V0Rm9yTG9jYXRpb25SZXF1ZXN0GiYuQ29zdENlbnRlcn'
    'NTdmMuQ29zdENlbnRlcnNTZXRSZXNwb25zZRJjChJHZXRGb3JMb2NhdGlvbkpzb24SJS5Db3N0'
    'Q2VudGVyc1N2Yy5HZXRGb3JMb2NhdGlvblJlcXVlc3QaJi5Db3N0Q2VudGVyc1N2Yy5Db3N0Q2'
    'VudGVyc1NldFJlc3BvbnNlEm0KFUdldEZvckNvc3RDZW50ZXJUeXBlcxIsLkNvc3RDZW50ZXJz'
    'U3ZjLkdldEZvckNvc3RDZW50ZXJUeXBlc1JlcXVlc3QaJi5Db3N0Q2VudGVyc1N2Yy5Db3N0Q2'
    'VudGVyc1NldFJlc3BvbnNlEnEKGUdldEZvckNvc3RDZW50ZXJUeXBlc0pzb24SLC5Db3N0Q2Vu'
    'dGVyc1N2Yy5HZXRGb3JDb3N0Q2VudGVyVHlwZXNSZXF1ZXN0GiYuQ29zdENlbnRlcnNTdmMuQ2'
    '9zdENlbnRlcnNTZXRSZXNwb25zZRJzChhHZXRGb3JCdXNpbmVzc0NsYXNzX1NhbGUSLy5Db3N0'
    'Q2VudGVyc1N2Yy5HZXRGb3JCdXNpbmVzc0NsYXNzX1NhbGVSZXF1ZXN0GiYuQ29zdENlbnRlcn'
    'NTdmMuQ29zdENlbnRlcnNTZXRSZXNwb25zZRJ3ChxHZXRGb3JCdXNpbmVzc0NsYXNzX1NhbGVK'
    'c29uEi8uQ29zdENlbnRlcnNTdmMuR2V0Rm9yQnVzaW5lc3NDbGFzc19TYWxlUmVxdWVzdBomLk'
    'Nvc3RDZW50ZXJzU3ZjLkNvc3RDZW50ZXJzU2V0UmVzcG9uc2UScQoXR2V0Rm9ySW5zcGVjdGlv'
    'blN5c3RlbXMSLi5Db3N0Q2VudGVyc1N2Yy5HZXRGb3JJbnNwZWN0aW9uU3lzdGVtc1JlcXVlc3'
    'QaJi5Db3N0Q2VudGVyc1N2Yy5Db3N0Q2VudGVyc1NldFJlc3BvbnNlEnUKG0dldEZvckluc3Bl'
    'Y3Rpb25TeXN0ZW1zSnNvbhIuLkNvc3RDZW50ZXJzU3ZjLkdldEZvckluc3BlY3Rpb25TeXN0ZW'
    '1zUmVxdWVzdBomLkNvc3RDZW50ZXJzU3ZjLkNvc3RDZW50ZXJzU2V0UmVzcG9uc2USZQoRR2V0'
    'Rm9yTWVhc3VyZVVuaXQSKC5Db3N0Q2VudGVyc1N2Yy5HZXRGb3JNZWFzdXJlVW5pdFJlcXVlc3'
    'QaJi5Db3N0Q2VudGVyc1N2Yy5Db3N0Q2VudGVyc1NldFJlc3BvbnNlEmkKFUdldEZvck1lYXN1'
    'cmVVbml0SnNvbhIoLkNvc3RDZW50ZXJzU3ZjLkdldEZvck1lYXN1cmVVbml0UmVxdWVzdBomLk'
    'Nvc3RDZW50ZXJzU3ZjLkNvc3RDZW50ZXJzU2V0UmVzcG9uc2USUAoIR2V0QnlLZXkSHy5Db3N0'
    'Q2VudGVyc1N2Yy5HZXRCeUtleVJlcXVlc3QaIy5Db3N0Q2VudGVyc1N2Yy5Db3N0Q2VudGVyc1'
    'Jlc3BvbnNlElQKDEdldEJ5S2V5SnNvbhIfLkNvc3RDZW50ZXJzU3ZjLkdldEJ5S2V5UmVxdWVz'
    'dBojLkNvc3RDZW50ZXJzU3ZjLkNvc3RDZW50ZXJzUmVzcG9uc2USSAoGR2V0QWxsEhYuZ29vZ2'
    'xlLnByb3RvYnVmLkVtcHR5GiYuQ29zdENlbnRlcnNTdmMuQ29zdENlbnRlcnNTZXRSZXNwb25z'
    'ZRJMCgpHZXRBbGxKc29uEhYuZ29vZ2xlLnByb3RvYnVmLkVtcHR5GiYuQ29zdENlbnRlcnNTdm'
    'MuQ29zdENlbnRlcnNTZXRSZXNwb25zZRJMCgZJbnNlcnQSHS5Db3N0Q2VudGVyc1N2Yy5JbnNl'
    'cnRSZXF1ZXN0GiMuQ29zdENlbnRlcnNTdmMuQ29zdENlbnRlcnNSZXNwb25zZRJQCgpJbnNlcn'
    'RKc29uEh0uQ29zdENlbnRlcnNTdmMuSW5zZXJ0UmVxdWVzdBojLkNvc3RDZW50ZXJzU3ZjLkNv'
    'c3RDZW50ZXJzUmVzcG9uc2USRwoGVXBkYXRlEh0uQ29zdENlbnRlcnNTdmMuVXBkYXRlUmVxdW'
    'VzdBoeLkNvc3RDZW50ZXJzU3ZjLlVwZGF0ZVJlc3BvbnNlEkcKBkRlbGV0ZRIdLkNvc3RDZW50'
    'ZXJzU3ZjLkRlbGV0ZVJlcXVlc3QaHi5Db3N0Q2VudGVyc1N2Yy5EZWxldGVSZXNwb25zZQ==');
